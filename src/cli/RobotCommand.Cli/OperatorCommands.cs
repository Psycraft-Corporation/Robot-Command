...
internal static class OperatorCommands
{
    ...
    private static OperatorCommandQueueSnapshot[] FilterCommands(IEnumerable<OperatorCommandQueueSnapshot> commands, string? unitId, string? teamId, string? state, IOperatorTargetScopeWorkflow? targetScope = null)
    {
