...
internal static class Phase5Commands
{
        ...
        switch (command)
        {
            ...
            case "step":
                ...
                var step = action switch
                {
                    ...
                    "add-loiter" => await workflow.AddTimedLoiterAsync(id, args.Required("geometry"), double.Parse(args.Required("seconds")), token),
                    ...
                    "move" => await workflow.MoveStepAsync(id, args.Required("step"), int.Parse(args.Required("index")), token),
    ...
    {
        var speed = double.Parse(args.Required("speed"));
    ...
    {
        var altitude = double.Parse(args.Required("altitude"));
    ...
    private static IReadOnlyDictionary<int, int> ParseSettings(IReadOnlyList<string> values)
    {
