...
public sealed class FlightMissionPreviewControl : Control
{
    ...
    public override void Render(DrawingContext context)
    {
        ...
        {
            MapDrawingPrimitives.DrawText(context, "Select a mission to preview its route.", new Point(16, 16), Brushes.LightGray);
            return;
        }
        ...
        if (unitPoint is not null)
        {
            ...
            var firstStep = route.FirstOrDefault();
    ...
    private static IPen Dashed(IPen pen) => new Pen(pen.Brush, pen.Thickness, new DashStyle([6, 4], 0));

    private static IBrush StepBrush(FlightMissionStep step) => step.Kind switch
    {
