...
public sealed class FormationLibraryStore
{
    ...
    public async Task<FormationDocument> SaveAsync(FormationDocument document, CancellationToken cancellationToken = default, bool allowEmpty = false)
    {
