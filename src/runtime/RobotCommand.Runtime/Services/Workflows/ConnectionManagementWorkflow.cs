...
public sealed class UnitObservationWorkflow : IUnitObservationWorkflow, IDisposable
{
    ...
    private static void Subscribe(System.Collections.ObjectModel.ReadOnlyObservableCollection<object> _) { }
        ...
        IReadOnlyList<ConnectionRecord> connectionRecords)
    {
        ...
        var defaultConnectionId = vehicle.ConnectionIds.Count > 0 ? vehicle.ConnectionIds[0] : null;
        var commandAuthorityConnectionId = definition?.CommandAuthorityConnectionId ?? defaultConnectionId;
        var telemetryAuthorityConnectionId = definition?.TelemetryAuthorityConnectionId ?? defaultConnectionId;
        var diagnosticsAuthorityConnectionId = definition?.DiagnosticsAuthorityConnectionId ?? defaultConnectionId;
