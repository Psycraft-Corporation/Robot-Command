...
public sealed class GhostProfileAssetWorkflow : IGhostProfileAssetWorkflow, IDisposable
{
    ...
    private static async Task<GhostProfileAssetSnapshot> ValidateMeshAsync(string path, string fileName, CancellationToken cancellationToken)
    {
