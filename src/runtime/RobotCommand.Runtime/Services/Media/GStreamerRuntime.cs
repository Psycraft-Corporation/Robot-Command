...
public sealed class GStreamerRuntime : IGStreamerRuntime
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            Diagnostics = new GStreamerRuntimeDiagnostics(
                ...
                supported.Count == 0
                    ? $"{version}. Core frame plugins are installed, but no Logos network playback protocol is currently available."
