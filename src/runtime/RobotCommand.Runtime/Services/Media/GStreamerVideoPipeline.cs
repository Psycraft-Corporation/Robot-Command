...
public sealed class GStreamerVideoPipeline : IGStreamerVideoPipeline
{
    ...
    public async Task StopAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await StopCoreAsync(publishStopped: true, cancellationToken: cancellationToken);
        }
        finally
        {
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        try
        {
            await StopCoreAsync(publishStopped: false, cancellationToken: CancellationToken.None);
        }
        finally
        {
            _operationGate.Release();
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            await StopCoreAsync(publishStopped: false, cancellationToken: cancellationToken);
