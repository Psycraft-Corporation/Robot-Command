...
public sealed class AutonomyDeploymentBundleService : IAutonomyDeploymentBundleService, IDisposable
{
    ...
    private static async Task<AutonomyBundleInspectionResult> InspectArchiveAsync(
        string fullPath,
        ZipArchive archive,
