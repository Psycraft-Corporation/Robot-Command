...
public sealed class EvidenceLibrary : IEvidenceLibrary, IDisposable
{
    ...
    private static EvidenceRecord ToRecord(EvidenceManifest manifest, string filePath, string metadataPath)
        => new(
            manifest.Id,
            manifest.Kind,
            manifest.Title,
