...
public sealed class Px4ParameterProfileStore : IPx4ParameterProfileStore
{
    ...
    private Px4ParameterProfile CreateProfile(string name, string path, Px4ParameterFile document, string content, DateTimeOffset createdAt, string? firmwareVersion = null, string? sourceFileName = null)
    {
