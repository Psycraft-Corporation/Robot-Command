...
public interface IMavlinkMissionClient
{
    ...
    Task<MavlinkMissionTransferResult> SetMissionModeAsync(string vehicleId, bool paused, CancellationToken cancellationToken = default, bool restartFromBeginning = true, bool sendMissionStartCommand = false);
