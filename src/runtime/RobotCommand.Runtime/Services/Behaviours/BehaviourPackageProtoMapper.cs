...
{
    public static async Task<V1.BehaviourPackage> ToProtoAsync(
    ...
    public static BehaviourPackageValidationResult ToValidationResult(
    ...
    public static BehaviourPackageGatewayMutationResult ToDeleteResult(
