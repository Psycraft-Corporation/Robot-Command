...
internal sealed class BehaviourPackageIntegrityInspector
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var manifest = await BehaviourPackageManifestReader.ReadAsync(manifestPath, cancellationToken);
    ...
    private static IEnumerable<PackageEntry> EnumerateEntries(string root, CancellationToken cancellationToken)
    {
