...
public sealed class GeometryDocumentCodec
{
    ...
    public static string Serialize(GeometryDocument document)
    {
    ...
    public static string ComputeContentSha256(GeometryDocument document)
    {
        ArgumentNullException.ThrowIfNull(document);
        var normalized = Normalize(document);
    ...
    public static GeometryDocument Normalize(GeometryDocument document)
    {
        ArgumentNullException.ThrowIfNull(document);
