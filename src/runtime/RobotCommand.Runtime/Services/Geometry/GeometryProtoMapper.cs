...
public sealed class GeometryProtoMapper
{
    ...
    public GeometryDocument ToDocument(V1.GeometryObject geometry, string connectionId)
    {
        ...
        {
            ContentSha256 = _codec.ComputeContentSha256(normalized),
            IsDirty = false
        };
    }

    public RemoteGeometryRecord ToRecord(
        V1.GeometryRecord record,
        string connectionId,
    ...
    public GeometryValidationResult ToValidationResult(
    ...
    public GeometryCommandResult ToDeleteResult(V1.DeleteGeometryObjectResponse response)
    {
        ArgumentNullException.ThrowIfNull(response);
    ...
    public GeometryRegistrySnapshot ToRegistrySnapshot(
    ...
    private RemoteGeometryRecord CreateRecordFromObject(
