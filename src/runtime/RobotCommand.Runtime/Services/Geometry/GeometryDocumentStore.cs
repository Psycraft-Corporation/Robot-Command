...
public sealed class GeometryDocumentStore : IGeometryDocumentStore, IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var content = GeometryDocumentCodec.Serialize(document);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var content = GeometryDocumentCodec.Serialize(prepared);
