...
public static class SelectionFactory
{
    public static OperationalSelection From(ConnectionRecord connection) => new(
        ...
        [
            ...
            new("Last seen", connection.LastSeen?.ToLocalTime().ToString("G", CultureInfo.CurrentCulture) ?? "Never"),
            new("Last attempt", connection.LastAttempt?.ToLocalTime().ToString("G", CultureInfo.CurrentCulture) ?? "Never"),
    ...
    public static OperationalSelection From(RuntimeRecord runtime) => new(
        ...
        [
            ...
            new("Capabilities", (runtime.CapabilityKeys?.Count ?? 0).ToString(CultureInfo.InvariantCulture)),
            new("Last seen", runtime.LastSeen?.ToLocalTime().ToString("G", CultureInfo.CurrentCulture) ?? "Never")
        ]);
    ...
    public static OperationalSelection From(TeamRecord team) => new(
        ...
        [
            ...
            new("Last seen", team.LastSeen?.ToLocalTime().ToString("G", CultureInfo.CurrentCulture) ?? "Never")
        ]);
    ...
    public static OperationalSelection From(VehicleRecord vehicle) => new(
        ...
        [
            ...
            new("Capabilities", (vehicle.CapabilityKeys?.Count ?? 0).ToString(CultureInfo.InvariantCulture)),
            new("Last seen", vehicle.LastSeen?.ToLocalTime().ToString("G", CultureInfo.CurrentCulture) ?? "Never")
        ]);
    ...
    public static OperationalSelection From(OperationalCommandRecord command) => new(
        ...
        [
            ...
            new("Created", command.CreatedAt.ToLocalTime().ToString("G", CultureInfo.CurrentCulture)),
            new("Updated", command.UpdatedAt.ToLocalTime().ToString("G", CultureInfo.CurrentCulture))
        ]);
    ...
    public static OperationalSelection From(ConsoleEventRecord item) => new(
        ...
        [
            ...
            new("Time", item.Timestamp.ToLocalTime().ToString("G", CultureInfo.CurrentCulture))
        ]);
