...
| Newtonsoft.Json | 13.0.3 | MIT | https://github.com/JamesNK/Newtonsoft.Json | Private compatibility pin for the portable renderer dependency graph |
...
| --- | --- | --- |
| GStreamer Windows MSVC runtime | 1.26.11, https://gstreamer.freedesktop.org/ | LGPL-2.1-or-later with plugin-specific notices; the pinned Windows installer belongs under `build/third-party/gstreamer/1.26.11/win-x64/` and bundled notices are in `THIRD-PARTY-NOTICES/GStreamer.txt` during packaging |
